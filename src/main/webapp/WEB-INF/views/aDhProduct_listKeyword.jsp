							  ...
							  <!-- keyword1 keyword2, prod_salests 같이 조회  -->
                                  <form id="ffrr" action="prodSearch" onsubmit="return false">
			                        ...
			                        <div class="mb-3 row">
                                      ...
                                      <!-- 날짜 선택 -->
			                          <div class="col-md-2">
			                            <input class="form-control" type="date" value="2022-06-14"/>
			                          </div>
                                      ~
                                      <div class="col-md-2">
			                            <input class="form-control" type="date" value="2022-06-14"/>
                            ...
                            <nav aria-label="Page navigation" class="container-p-y">
                             <ul class="pagination justify-content-center">
                               ...
                               <c:forEach var="i" begin="${pg.startPage}" end="${pg.endPage}">
                                   <li class="page-item">
                                   		<%--  <c:choose test="${keyword2=null || keyword2.equals('')}" >
                                   				 <a class="page-link" href="prodSearch?currentPage=${i}&search=0&keyword2=${keyword2}&search=0&keyword1=${keyword1}">${i}</a>
                                   			</c:when>
                                   			<c:when test="${keyword1=null || keyword1.equals('')}" >   
                                   				 <a class="page-link" href="prodSearch?currentPage=${i}&search=0&keyword2=${keyword2}&search=0&keyword1=${keyword1}">${i}</a>
                                   			</c:when>
                                   		</c:choose> --%> 
                                   		<%-- 	<a class="page-link" id="bt" onclick="btnClick()" >${i}</a>  --%>
                                   		<%-- 
                                   		<c:if test="{keyword2=null || keyword2.equals('') && keyword1 !=null}">
                                   		  <a class="page-link" href="prodSearch?currentPage=${i}&search=0&keyword1=${keyword1}&keyword2=${''}">${i}</a>
                                   		</c:if>
                                   		<c:if test="{keyword1=null || keyword1.equals('') && keyword2 !=null}">
                                   		  <a class="page-link" href="prodSearch?currentPage=${i}&search=0&keyword2=${keyword2}&keyword1=${''}">${i}</a>
                                   		</c:if>
                                   		 --%>
                                     <%-- <a class="page-link" href="prodSearch?currentPage=${i}&search=0&keyword2=${keyword2}">${i}</a> --%>
