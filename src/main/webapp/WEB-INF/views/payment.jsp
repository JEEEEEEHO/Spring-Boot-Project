				...
				<form action="/kakaoPay" name="frm" id="frm" method="post" onsubmit="return false">
					...
					<div id="right_side">
						...
						<div id="pay">
							...
							<button class="btn btn-dark" id="goPay" onclick="document.getElementById('frm').submit()"><fmt:formatNumber value="${total_amount }" groupingUsed="true"></fmt:formatNumber>원 결제하기</button>
