					...
					<div class="container-xxl flex-grow-1 container-p-y">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<table class="table table-borderless"  border="1">
									<tr>
										<td style="padding-bottom: 0px;"></td><th style="padding-bottom: 0px; font-size: 1.3em"><a href="#">리뷰</a></th><td style="padding-bottom: 0px;"></td><th style="padding-bottom: 0px; font-size: 1.3em"><a href="#">신규회원</a></th>
									</tr>
									<tr class="image">
