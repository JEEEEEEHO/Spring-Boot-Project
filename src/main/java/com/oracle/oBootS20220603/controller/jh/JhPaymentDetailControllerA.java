...
public class JhPaymentDetailControllerA {
	...
	public String delivlistA(Payment payment,String currentPage, Model model) {
	...
	public String selListA(Payment payment,String currentPage, Model model) {
	...
	public String canListA(Payment payment,String currentPage, Model model) {
