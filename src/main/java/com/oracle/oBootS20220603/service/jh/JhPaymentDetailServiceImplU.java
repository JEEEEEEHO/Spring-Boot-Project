...
public class JhPaymentDetailServiceImplU implements JhPaymentDetailServiceU {
	...
	public List<Payment> orderList(String id) {
		...
		System.out.println("JhPaymentDetailServiceImplU orderList.get(0).getPayno()"+orderList.get(0).getPayno());
		System.out.println("JhPaymentDetailServiceImplU orderList.get(0).getPay_sts()"+orderList.get(0).getPay_sts());
		return orderList;
	}
