...
public class DhProdServiceImplU implements DhProdServiceU {
	...
	// 상품 상세페이지
		...
		public List<Product> wishList(String id) {
			...
			System.out.println("DhProductDaoImpl idWishList idWishList->"+idWishList.get(0).getProdno());
			return idWishList;
		}
...
//      상세페이지->회원존재->장바구니 담기
//		@Override
//		public int prodDetailCount(Product product2) {
//			int result=0;
//			System.out.println("DhProdServiceImpl prodDetailCount Start...");
//			result=dhpd.prodDetailCount(product2);
//			System.out.println("DhProdServiceImpl prodDetailCount result->"+result);
//			return result;
//		}
