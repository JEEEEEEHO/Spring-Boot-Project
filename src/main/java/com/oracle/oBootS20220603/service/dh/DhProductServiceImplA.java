...
import com.oracle.oBootS20220603.dao.dh.DhProductDaoA;
import com.oracle.oBootS20220603.model.Product;

@Service
public class DhProductServiceImplA implements DhProdServiceA {

	@Autowired
	private DhProductDaoA dhpd;
	...
	public int adminProdDelAJAX(Product product) {
		...
		result=dhpd.adminProdDelAJAX(product);
